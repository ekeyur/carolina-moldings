...
const faqs = [
  ...
  },
  {
    ...
    answer:
      "Yes! If we don't have what you're looking for in our standard catalog, we're happy to design and manufacture custom pieces to fit your specific needs. Our engineering team works closely with clients to develop solutions that meet exact specifications.",
  },
  {
    question: "How long has Carolina Moldings been in business?",
    answer:
      "Carolina Moldings has been a family-owned and operated business since 1975. That's over 50 years of experience serving the gas industry with quality products and exceptional customer service.",
  },
  {
  ...
  },
  {
    ...
    answer:
      "Yes, we offer competitive pricing for wholesale and bulk orders. Contact us directly to discuss your needs and receive a custom quote based on your order volume.",
  },
  {
    question: "Where are you located?",
    answer:
      "Our facility is located at 3600 Woodpark Blvd. Suite A, Charlotte NC, 28206. We ship our products nationwide. We also ship to our customers in Canada and Mexico.",
  },
  {
    question: "How quickly can you ship products?",
    answer:
      "We understand that time is money and a day without materials is a day without production. We maintain inventory of our most popular products and prioritize fast, reliable shipping. Contact us for specific lead times on your order.",
  },
  {
    question: "Do you have a product catalog available?",
    answer:
      "Yes! You can view our full product catalog online or download a PDF version for offline reference. Visit our Products page or click the PDF Catalog button on our homepage.",
  },
];
            ...
            {faqs.map((faq, index) => (
              ...
              >
                ...
                >
                  ...
                  <svg
                    className={`w-5 h-5 text-steel-500 shrink-0 transition-transform ${
