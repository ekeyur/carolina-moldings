...
const itronCovers = [
  {
    ...
    features: [
      "Will accept 2 Tophat tamper plugs (not included)",
      "Tamper System Kit available",
    ],
    unitsPerCase: "60",
    tamperCompatible: true,
    image: "/products/I-100G.png",
  },
  {
    model: "S-105",
    description: "Comes with or without Sure Seal preapplied gasket",
    features: [
      "Will accept 2 #1 Snap Seal tamper plugs (not included)",
      "Tamper System Kit available",
    ],
    unitsPerCase: "105",
    tamperCompatible: true,
    image: "/products/S-105.png",
  },
];

const endpointCovers = [
  {
    model: "A-40G",
    description: "Comes with or without Sure Seal preapplied gasket",
    features: [
    ...
    tamperCompatible: true,
    meterType: "American",
    image: "/products/A-40G-endpoint.png",
    imagePadding: "p-10",
  },
  {
    model: "R-40G",
    ...
    tamperCompatible: true,
    meterType: "Rockwell",
    image: "/products/R-40G-endpoint.png",
    imagePadding: "p-10",
  },
  {
    model: "A-100G",
    ...
    tamperCompatible: true,
    meterType: "American",
    image: "/products/A-100G-endpoint.png",
  },
  {
    model: "R-100G",
    description: "Does not use Sure Seal preapplied gasket",
    ...
    tamperCompatible: true,
    meterType: "Rockwell",
    image: "/products/R-100G-endpoint.png",
  },
];

export default function ItronIndexCoversPage() {
  return (
      ...
      <section className="pt-32 pb-16 bg-steel-900 relative overflow-hidden">
        ...
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <p className="text-steel-400 text-lg max-w-2xl">
            Quality index covers designed for Itron and Sprague gas meters, plus
            endpoint covers compatible with various meter types. Available with
            Snap Seal tamper system compatibility.
          </p>
        </div>
      </section>

      {/* Itron/Sprague Products */}
      ...
      <section className="py-16 lg:py-24 bg-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="mb-12">
            ...
            <p className="text-steel-600">
              Endpoint covers compatible with American and Rockwell meter types.
            </p>
          </div>

          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6">
            {endpointCovers.map((product) => (
              <div
                key={product.model}
              ...
              >
                <div className="w-full aspect-square mb-6 bg-steel-100 rounded-lg flex items-center justify-center overflow-hidden relative">
                  <div className="absolute top-3 left-3 px-2 py-1 bg-steel-700 text-white text-xs font-semibold rounded z-10">
                    {product.meterType}
                  </div>
                  {product.tamperCompatible && (
                    <div className="absolute top-3 right-3 px-2 py-1 bg-primary-600 text-white text-xs font-semibold rounded z-10">
                  ...
                  {product.image ? (
                    <Image
                      ...
                      alt={product.model}
                      fill
                      className={`object-contain ${product.imagePadding || "p-6"}`}
                    />
                  ) : (
                    <div className="text-center p-4">
                      <div className="w-16 h-16 mx-auto mb-2 bg-steel-200 rounded-lg flex items-center justify-center">
                        <svg
                ...
                <h3 className="font-display text-xl font-bold text-steel-900 mb-2 group-hover:text-primary-600 transition-colors">
                  {product.model}
                </h3>
          ...
          <div className="grid md:grid-cols-2 gap-12 items-center">
            <div>
              <h2 className="font-display text-3xl md:text-4xl font-bold text-steel-900 mb-6">
                Itron & Sprague Compatibility
              </h2>
              <div className="space-y-4 text-steel-600 leading-relaxed">
                <p>
                  Our Itron and Sprague index covers are manufactured to precise
                  specifications, ensuring a perfect fit for your meters. Each
                  cover is designed for durability and long-term performance in
                  the field.
                </p>
                <p>
              ...
              <ul className="mt-6 space-y-3">
                {[
                  "Precision-engineered for Itron/Sprague meters",
                  "Snap Seal tamper system compatible",
