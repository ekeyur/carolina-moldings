...
const products = [
  {
    ...
    items: [
      { name: 'American / Honeywell Index Covers', href: '/products/american-index-covers', description: 'Precision-fit covers for American and Honeywell meters', image: '/american-honeywell.png' },
      { name: 'Rockwell / Sensus Index Covers', href: '/products/rockwell-index-covers', description: 'Durable covers for Rockwell and Sensus meters', image: '/rockwell-sensus.png' },
      { name: 'Sprague / Itron Index Covers', href: '/products/itron-index-covers', description: 'Quality covers for Sprague and Itron meters', image: '/sprague-itron.png' },
    ],
  },
  {
    category: 'Security Products',
    items: [
      { name: 'Tamper System', href: '/products/tamper-system', description: 'Snap Seal™ tamper-evident security systems' },
      { name: 'Meter Screws', href: '/products/meter-screws', description: 'Security screws and fasteners' },
    ],
  },
  {
    category: 'Accessories',
    items: [
      { name: 'Paint Covers', href: '/products/paint-covers', description: 'Protective covers for meter painting' },
      { name: 'Miscellaneous', href: '/products/misc', description: 'Additional meter accessories and parts' },
    ],
  },
];
      ...
      <section className="pt-32 pb-16 bg-steel-900">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <p className="text-steel-400 text-lg max-w-2xl">
            ...
            and accessories. Quality products trusted by utilities nationwide since 1975.
          </p>
        </div>
      </section>
                  ...
                  >
                    <div className="w-14 h-14 mb-4 bg-steel-100 rounded-lg flex items-center justify-center group-hover:bg-primary-50 transition-colors overflow-hidden relative">
                      {item.image ? (
                        ...
                        <svg className="w-6 h-6 text-steel-600 group-hover:text-primary-600" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                    ...
                    <p className="text-steel-600 text-sm mb-4">{item.description}</p>
