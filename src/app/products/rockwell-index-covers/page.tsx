...
const rockwellCovers = [
  {
    ...
    features: [
      "Accepts 2 #1 Snap Seal tamper plugs",
      "Tamper System Kit available",
    ],
    unitsPerCase: "220 (without gasket) / 200 (with gasket)",
    tamperCompatible: true,
    image: "/products/R-103.png",
  },
  {
    model: "R-104",
    description: "Comes with or without our Sure Seal preapplied gasket",
  ...
  },
  {
    ...
    features: [
      "Accepts 2 #2 Snap Seal tamper plugs",
      "Tamper System Kit available",
    ],
    unitsPerCase: "45",
    tamperCompatible: true,
    image: "/products/R-105.png",
  },
  {
    model: "R-40G",
    description: "Comes with or without our Sure Seal preapplied gasket",
...
export default function RockwellIndexCoversPage() {
  return (
      ...
      <section className="pt-32 pb-16 bg-primary-100 relative overflow-hidden">
        ...
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <p className="text-steel-600 text-lg max-w-2xl">
            Premium index covers designed for Rockwell and Sensus gas meters.
          ...
          <div className="grid md:grid-cols-2 gap-12 items-center">
            <div>
              <h2 className="font-display text-3xl md:text-4xl font-bold text-steel-900 mb-6">
                Rockwell & Sensus Compatibility
              </h2>
              <div className="space-y-4 text-steel-600 leading-relaxed">
                <p>
                  Our Rockwell index covers are precision-engineered to fit
                  Rockwell and Sensus gas meters perfectly. Each cover is
                  manufactured to exact specifications ensuring reliable
                  performance in the field.
                </p>
                <p>
                  Choose from models with or without our Sure Seal preapplied
                  gasket for weather protection, and select tamper-compatible
                  versions to work with our Snap Seal security system.
                </p>
              </div>
              <ul className="mt-6 space-y-3">
                {[
                  "Precision fit for Rockwell/Sensus meters",
                  "Optional Sure Seal gasket",
