...
const meterBrands = [
  {
    ...
    description: 'Index covers designed specifically for American and Honeywell meters with precision fit and durability.',
  ...
  },
  {
    ...
    description: 'Comprehensive range of covers for Rockwell and Sensus meters, built to industry specifications.',
  ...
  {
    name: 'Sprague / Itron',
    description: 'Durable index covers compatible with Sprague and Itron meter systems.',
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="max-w-3xl mb-16">
          ...
          <p className="text-lg text-steel-600">
            Browse our precision-engineered index covers and tamper systems designed 
            for compatibility with major meter manufacturers.
          </p>
        </div>
        ...
        <div className="mt-16 pt-16 border-t border-steel-200">
          <h3 className="font-display text-2xl font-semibold text-steel-900 mb-8">More Product Categories</h3>
          <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-4">
            {[
              { name: 'Tamper System', href: '/products/tamper-system', icon: 'shield' },
              { name: 'Meter Screws', href: '/products/meter-screws', icon: 'tool' },
              { name: 'Paint Covers', href: '/products/paint-covers', icon: 'brush' },
              ...
              >
                <div className="w-12 h-12 bg-steel-200 rounded-lg flex items-center justify-center group-hover:bg-primary-100 transition-colors">
                  <svg className="w-6 h-6 text-steel-600 group-hover:text-primary-600 transition-colors" fill="none" viewBox="0 0 24 24" stroke="currentColor">
